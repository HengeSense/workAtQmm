define(function (require, exports, module) {
    ...
    var temp_view = ["<div id=\"aj-fixed-right-bar\" ng-controller=\"rightBar\"",
        "     ng-style=\"{right : (isShow ? \'0px\' : \'-187px\'), display : (isVisible ? \'block\' : \'none\')}\">",
        "    <div class=\"abody\">",
        "        <div class=\"aleft\">",
        "            <ul class=\"left-ul\">",
        "                <li style=\"width:100%;height:32px;\"></li>",
        "                <li class=\"logo-bg\" ng-style=\"{height : (logoHeight + \'px\')}\" ng-click=\"mustShow()\"></li>",
        "                <li class=\"atab{{select === $index ? \' aj-select\' : \'\'}}{{$last ? \' no-border\' : \'\'}}\"",
        "                    ng-repeat=\"item in items\" ng-click=\"load(item.url, $index);show($index)\">",
        "                    <div class=\"inside\"><i class=\"{{item.icon}}\" ng-style=\"{\'font-size\' : fontSize}\"></i> <span ng-bind=\"item.name\"",
