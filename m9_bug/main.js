       ...
       draw_lipinka: function (obj) {
            ...
            var d = dialog({
                    ...
                    ok: function () {
                        ...
                        window.location.href="/order/cart?sysno="+id+"&buycount="+buycount;
         ...
         //礼品卡订单接口
       submit_lipinka_order: function (obj) {
            ...
            Youhui.api.post("/order/maika", {
                ...
                if (json.code >= 1) {
                     window.location.href="/order/pay?orderid="+json.orderid;
                } else {
                    var d = dialog({
                        title: '礼品卡订单提交失败提示',
                        content: json.result,
...
$(function () {
    ...
    $("#_QMM_ALLSORT").load("/html/newcategory.htm"); //load("/html/category.html");
    ...
    if (g.length > 0) {
        //滚动
        g.find(".tit li").on("mouseover", function () {
            $(this).addClass("hover")
        }).on("mouseout", function () {
        ...
        /*         $(".list-main-adj li.hover-ops").on("mouseover", function () {
        var $this = $(this);
        $this.addClass("hover");
...
function rating(obj, id, rating_type) {
...
function loadList() {
    ...
    switch (channel) {
        ...
        case "productlist":
            page_per_load = 5;
            func = productlistLoad;
            break;
    }


    if (reach > top) {
        if (current_page % page_per_load != 0) {
            func();
        }
    }
}
...
function youhuiListLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/youhuipage?page=" + (current_page + 1) + "&sort=" + sort + "&category=" + category + "&site=" + site + "&time=" + time + "&area=" + area + "&status=" + status,
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
            $(".JPage_" + current_page).addClass("pageCurrent");
...
function huoDongListLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/huodongpage?page=" + (current_page + 1),
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
...
function couponlistLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/couponlistpage?page=" + (current_page + 1),
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
...
function productlistLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/productlistpage?page=" + (current_page + 1),
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
...
function faxianListLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/faxianpage?page=" + (current_page + 1) + "&sort=" + sort + "&category=" + category + "&site=" + site + "&time=" + time + "&area=" + area + "&status=" + status,
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
...
function haitaoListLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/haitaopage?page=" + (current_page + 1) + "&sort=" + sort + "&category=" + category + "&site=" + site + "&time=" + time + "&status=" + status,
        dataType: "html",
        success: function (html) {
            current_page = current_page + 1;
            $(".pagination a").removeClass("pageCurrent");
