...
function youhuiListLoad() {
    ...
    $.ajax({
        type: "get",
        url: "/myajax/youhuipage?page=" + (current_page + 1) + "&pagetype=" + pagetype + "&posttype="+ posttype + "&promotype=" + promotype + "&sort=" + sort + "&category=" + category + "&site=" + site + "&time=" + time + "&area=" + area + "&status=" + status + "&pagesize=" + pagesize,
        dataType: "html",
